    ...
    >
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <DialogContent className={classes.content}>
            <TextField fullWidth={true} label='Descrição' name='description' formik={formik} />
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField fullWidth={true} label='Quantidade' name='quantity' formik={formik} />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField fullWidth={true} label='Valor' name='value' formik={formik} />
              </Grid>
            </Grid>
